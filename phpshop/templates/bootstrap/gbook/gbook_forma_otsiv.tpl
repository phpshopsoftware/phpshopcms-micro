...
<form role="form" method="post" name="forma_gbook">
    ...
    <div class="form-group">
        ...
        <img src="phpshop/captcha2.php" alt="" border="0" align="left" style="margin-right:10px"> <input type="text" name="key"   class="form-control" id="exampleInputEmail1" placeholder="Код..." style="width:100px" required="">
