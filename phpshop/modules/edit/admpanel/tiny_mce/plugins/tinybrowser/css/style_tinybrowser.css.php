...
clear: none;
text-align: center;
height: <?php echo $_SESSION['tinybrowser']['thumbsize']+40; ?>px;
width: <?php echo $_SESSION['tinybrowser']['thumbsize']+25; ?>px;
font-size: <?php echo $_SESSION['tinybrowser']['thumbsize']; ?>px;
}
*+html .img-browser { width: <?php echo $_SESSION['tinybrowser']['thumbsize']+28; ?>px; } /*IE7+ */
* html .img-browser { width: <?php echo $_SESSION['tinybrowser']['thumbsize']+28; ?>px; } /*IE6- */
.img-browser img {
border: 0;
vertical-align: middle;
margin-top: -20px;
...
line-height: 13px;
overflow: hidden;
width: <?php echo $_SESSION['tinybrowser']['thumbsize']+20; ?>px;
height: 28px;
margin-top: -6px;
padding-left: 3px;
}
